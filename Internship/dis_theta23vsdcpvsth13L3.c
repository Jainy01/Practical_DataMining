...
#include "TString.h"
#include "TMath.h"
#include "OscCalculatorPMNSL3.h"
    gROOT->ProcessLine(".L OscCalculatorPMNSL3.C+");
...
/////    
    TFile *poutfile = new TFile(Form("oscprobL3_%s_%s_%s.root",savename.Data(),nufitver.Data(),strEnergy.Data()),"RECREATE");

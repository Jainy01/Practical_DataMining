...
void plot_dcpth23_prob_root6_clonesol_v3(){
    ...
    Bool_t isDrawSin13vsSin23 = true;
    ...
    TFile *pfile = new TFile("/Users/smithjainy/Documents/GitHub/nguyenthihien.github.io/Internship/oscprobL3_th23vsdcpvsth13_nufit5d2_2022nov_ene0d6.root","READ");
    ...
    TLatex *   text2kprecond = new TLatex(xpos,ypos-0.05,"(at L=885km, E_{#nu}=0.6 GeV)");
    ...
    */
    ...
    hhist2d[1]->Draw("colz");
    hhist2d[1]->GetZaxis()->SetRangeUser(0,0.08);
    ...
    hhist2d[3]->Draw("colz");
    hhist2d[3]->GetZaxis()->SetRangeUser(0,0.08);
    ...
    hhist2d[4]->Draw("colz");
    hhist2d[4]->GetZaxis()->SetRangeUser(0,0.08);
    ...
    hhist2d[5]->Draw("colz");
    hhist2d[5]->GetZaxis()->SetRangeUser(0,0.08);
